...
// `/work-graph/*` portfolio sub-router, plus the envelope-shaped not-found/error fallbacks every
// route inherits (the sub-router defines no `onError`/`notFound`, so these two stay the single
