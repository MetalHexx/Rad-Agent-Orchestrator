...
const MANIFESTS = [
  join(REPO_ROOT, 'harness-installers', 'standard', 'manifests', 'claude', 'v1.0.0-alpha.12.json'),
  join(REPO_ROOT, 'harness-installers', 'standard', 'manifests', 'copilot-cli', 'v1.0.0-alpha.12.json'),
  join(REPO_ROOT, 'harness-installers', 'standard', 'manifests', 'copilot-vscode', 'v1.0.0-alpha.12.json'),
];
