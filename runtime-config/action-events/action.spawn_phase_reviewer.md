...
Inline `data.context.phase_plan_doc` — the phase plan the phase was executed against — so the reviewer reviews conformance against it. When `data.context.review_report_path` is present, inline it too.
